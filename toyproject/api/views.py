...
from .serializers import (  TodoSerializer, 
                            ...
                            ChangeGuestToEmailSerializer,
                            ChangeGuestToKakaoSerializer,
...
class UpdateEmailAPIView(RetrieveUpdateAPIView):
    permissions_classes = [IsAuthenticated]
    serializer_class = ChangeGuestToEmailSerializer
    lookup_url_kwarg = 'user_id'
...
class UpdateKakaoAPIView(RetrieveUpdateAPIView):
    permissions_classes = [IsAuthenticated]
    serializer_class = ChangeGuestToKakaoSerializer
    lookup_url_kwarg = 'user_id'
